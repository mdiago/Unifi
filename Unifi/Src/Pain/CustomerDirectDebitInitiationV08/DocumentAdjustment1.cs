...
namespace Unifi.Pain.CustomerDirectDebitInitiationV08
{
    ...
    public class DocumentAdjustment1
    {
        ...
        /// <summary>
        /// Amount. Amount of money of the document adjustment.
        /// </summary>
        public ActiveOrHistoricCurrencyAndAmount Amt { get; set; }

        /// <summary>
        /// CreditDebitIndicator. Specifies whether the adjustment must be subtracted or added to the total amount.
        /// </summary>
        public CreditDebitCode CdtDbtInd { get; set; }

        /// <summary>
        /// True if CdtDbtInd specified
        /// </summary>
        [XmlIgnore()]
        public bool CdtDbtIndSpecified { get; set; }

        /// <summary>
        /// Reason. Specifies the reason for the adjustment. Max4Text.
        /// </summary>
        public string Rsn { get; set; }

        /// <summary>
        /// AdditionalInformation. Provides further details on the document adjustment. Max140Text.
        /// </summary>
