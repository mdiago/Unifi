...
namespace Unifi.Pain.CustomerDirectDebitInitiationV02
{
    ...
    /// <summary>
    /// A number of monetary units specified in an active or a historic currency where the unit of
    ...
    public class ActiveOrHistoricCurrencyAndAmount
    {
        ...
        /// <summary>
        /// <para>Currency: ActiveOrHistoricCurrencyCode with format:</para>
        /// <para>minInclusive: 0</para>
        /// <para>totalDigits: 18</para>
        /// <para>fractionDigits: 5</para>
        /// </summary>
        [XmlAttribute()]
