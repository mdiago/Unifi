...
namespace Unifi.Xml.Pain.CustomerDirectDebitInitiation
{
    ...
    public class DocumentLineIdentification
    {
        ...
        /// <summary>
        /// Type. Specifies the type of referred document line identification.
        /// </summary>
        public DocumentLineType Tp { get; set; }

        /// <summary>
        /// Number. Identification of the type specified for the referred document line. Max35Text.
        /// </summary>
        public string Nb { get; set; }

        /// <summary>
        /// RelatedDate. Date associated with the referred document line.
        /// </summary>
