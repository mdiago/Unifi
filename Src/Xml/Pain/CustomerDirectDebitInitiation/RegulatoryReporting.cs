...
namespace Unifi.Xml.Pain.CustomerDirectDebitInitiation
{
    ...
    /// <summary>
    /// Información necesaria debido a requisitos reglamentarios y / o legales.
    /// </summary>
    [Serializable()]
    public class RegulatoryReporting
    {
        ...
        /// <summary>
        /// Identifica si la información de informes reglamentarios se aplica
        /// al lado de débito, al lado de crédito o tanto al lado de débito
        /// como al de crédito de la transacción.
        /// </summary>
        ...
        /// <summary>
        /// Conjunto de elementos utilizados para proporcionar detalles sobre la información de informes reglamentarios.
        /// </summary>
        [XmlElement("Dtls")]
        public StructuredRegulatoryReporting[] Dtls { get; set; }
