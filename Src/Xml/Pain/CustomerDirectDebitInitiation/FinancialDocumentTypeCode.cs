...
namespace Unifi.Xml.Pain.CustomerDirectDebitInitiation
{
    ...
    public enum FinancialDocumentTypeCode
    {
        ...
        /// <summary>
        /// RemittanceAdviceMessage. Document is a remittance advice sent
        /// separately from the current transaction.
        /// </summary>
        RADM,

        /// <summary>
        /// RelatedPaymentInstruction. Document is a linked payment
        ...
        /// <summary>
        /// ForeignExchangeDealReference. Document is a pre-agreed or prearranged
        ...
        /// <summary>
        /// StructuredCommunicationReference. Document is a structured communication
