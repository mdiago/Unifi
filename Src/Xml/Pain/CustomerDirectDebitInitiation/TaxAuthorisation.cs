...
namespace Unifi.Xml.Pain.CustomerDirectDebitInitiation
{
    ...
    /// </summary>
    [Serializable()]
    public class TaxAuthorisation
    {

        /// <summary>
        /// Title. Title or position of debtor or the debtor's authorised representative. Max35Text.
        /// </summary>
        public string Titl { get; set; }

        /// <summary>
        /// Name. Name of the debtor or the debtor's authorised representative. Max140Text.
        /// </summary>
