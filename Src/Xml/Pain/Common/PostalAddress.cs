...
namespace Unifi.Xml.Pain.Common
{
    ...
    public class PostalAddress
    {
        ...
        /// </summary>
        [XmlElement("AdrTp", typeof(AddressTypeCode), Namespace = Namespaces.CustomerDirectDebitInitiationV02)]
        [XmlElement("AdrTp", typeof(AddressTypeChoice), Namespace = Namespaces.CustomerDirectDebitInitiationV08)]
