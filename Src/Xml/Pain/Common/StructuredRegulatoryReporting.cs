...
namespace Unifi.Xml.Pain.Common
{
    ...
    public class StructuredRegulatoryReporting
    {
        ...
        /// </summary>
        [XmlElement("Inf", typeof(string), Namespace = Namespaces.CustomerDirectDebitInitiationV01)]
        [XmlElement("Inf", typeof(string[]), Namespace = Namespaces.CustomerDirectDebitInitiationV08)]
