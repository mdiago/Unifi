...
namespace Unifi.Xml.Pain.Common
{
    ...
    public class MandateRelatedInformation
    {
        ...
        /// </summary>
        [XmlElement("Frqcy", typeof(FrequencyCode), Namespace = Namespaces.CustomerDirectDebitInitiationV02)]
        [XmlElement("Frqcy", typeof(FrequencyChoice), Namespace = Namespaces.CustomerDirectDebitInitiationV08)]
