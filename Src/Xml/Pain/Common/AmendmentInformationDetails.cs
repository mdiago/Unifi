...
namespace Unifi.Xml.Pain.Common
{
    ...
    public class AmendmentInformationDetails
    {
        ...
        ///// </summary>
        [XmlElement("OrgnlFrqcy", typeof(FrequencyCode), Namespace = Namespaces.CustomerDirectDebitInitiationV02)]
        [XmlElement("OrgnlFrqcy", typeof(FrequencyChoice), Namespace = Namespaces.CustomerDirectDebitInitiationV08)]
