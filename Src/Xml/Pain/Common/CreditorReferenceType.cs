...
namespace Unifi.Xml.Pain.Common
{
    ...
    public class CreditorReferenceType
    {
        ...
        /// <summary>
        /// CodeOrProprietary. Coded or proprietary format creditor reference type.
        /// </summary>
        public CreditorReferenceTypeChoice CdOrPrtry { get; set; }

        /// <summary>
        /// Issuer. Entity that assigns the credit reference type. Max35Text.
        /// </summary>
