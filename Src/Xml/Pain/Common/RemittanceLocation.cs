...
namespace Unifi.Xml.Pain.Common
{
    ...
    public class RemittanceLocation
    {
        ...
        /// <summary>
        /// RemittanceIdentification.Unique identification, as assigned by the initiating party, to unambiguously identify the
        ...
        /// <summary>
        /// A partir de la versión 5. RemittanceLocationDetails. 
        /// </summary>
        [XmlElement("RmtLctnDtls")]
        public RemittanceLocationData[] RmtLctnDtls { get; set; }
