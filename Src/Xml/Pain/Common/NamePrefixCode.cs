...
namespace Unifi.Xml.Pain.Common
{
    ...
    /// <summary>
    /// Especifica los términos utilizados para dirigirse formalmente a una persona.
    /// </summary>
    public enum NamePrefixCode
    {

        /// <summary>
        /// El título de la persona es Doctor o Dr.
        /// </summary>
        DOCT,

        /// <summary>
        /// El título de la persona es señor o señor
        /// </summary>
        MIST,
        ...
        /// <summary>
        /// El título de la persona es señora.
        /// </summary>
        MADM
