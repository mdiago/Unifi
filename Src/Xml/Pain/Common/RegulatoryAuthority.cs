...
namespace Unifi.Xml.Pain.Common
{
    ...
    public class RegulatoryAuthority
    {
        ...
        /// </summary>
        [XmlElement("AuthrtyNm", typeof(string), Namespace = Namespaces.CustomerDirectDebitInitiationV01)]
        public string Nm { get; set; }

        /// <summary>
        /// País de la entidad que requiere la información de reporte regulatorio.
        /// </summary>
        [XmlElement("AuthrtyCtry", typeof(string), Namespace = Namespaces.CustomerDirectDebitInitiationV01)]
