...
namespace Unifi.Xml.Pain.Common
{
    ...
    public class TaxRecord
    {
        ...
        /// </summary>
        [XmlElement("Tp", typeof(TaxType), Namespace = Namespaces.CustomerDirectDebitInitiationV01)]
        [XmlElement("Tp", typeof(string), Namespace = Namespaces.CustomerDirectDebitInitiationV08)]
        public virtual object Tp { get; set; }
