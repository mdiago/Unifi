...
namespace Unifi.Pain.CustomerDirectDebitInitiation
{
    ...
    public class ReferredDocumentInformation
    {
        ...
        /// Type.
        /// </summary>
        public ReferredDocumentType Tp { get; set; }

        /// <summary>
        /// Number. Unique and unambiguous identification of the referred document. Max35Text.
        /// </summary>
        public string Nb { get; set; }

        /// <summary>
        /// RelatedDate. Date associated with the referred document.
        /// </summary>
        [XmlElement(DataType = "date")]
        public DateTime RltdDt { get; set; }

        /// <summary>
        /// True if RltdDt specified.
        /// </summary>
        [XmlIgnore()]
        public bool RltdDtSpecified { get; set; }

        /// <summary>
        /// LineDetails. Set of elements used to provide the content of the referred document line.
        /// </summary>
        [XmlElement("LineDtls")]
        public DocumentLineInformation[] LineDtls { get; set; }
