...
namespace Unifi.Pain.CustomerDirectDebitInitiation
{
    ...
    public partial class AccountIdentificationChoice
    {
        ...
        [XmlElement("Othr", typeof(GenericIdentificationCdOrPrtry))]
        [XmlChoiceIdentifier("ItemElementName")]
        public object Item { get; set; }


        /// <summary>
        /// 'Othr' no es un valor válido para la versión 1; en su lugar hay que 
        /// utilizar 'BBAN', 'IBAN', 'PrtryAcct' o 'UPIC' ( estos valores sólo
        /// son válidos para la versión 1.
        /// </summary>
        [XmlIgnore()]
