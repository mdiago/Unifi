...
namespace Unifi.Pain.CustomerDirectDebitInitiation
{
    ...
    public class GenericIdentification
    {
        ...
        /// <summary>
        /// Identification. Proprietary information, often a code, 
        /// issued by the data source scheme issuer. Exact4AlphaNumericText.
        /// </summary>
        public string Id { get; set; }

        /// <summary>
        /// Issuer.Entity that assigns the identification. Max35Text.
        /// </summary>
        public string Issr { get; set; }

        /// <summary>
        /// SchemeName. Short textual description of the scheme. Max35Text. 
        /// </summary>
