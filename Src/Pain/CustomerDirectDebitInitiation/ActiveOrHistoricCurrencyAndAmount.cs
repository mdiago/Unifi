...
namespace Unifi.Pain.CustomerDirectDebitInitiation
{
    ...
    /// <summary>
    /// Número de unidades monetarias expresadas en una codificación de monedad compatible
    /// con las especificaciones de la ISO 4217. Clase utilizada a partir de la versión 2.
    /// </summary>
    [Serializable()]
    public class ActiveOrHistoricCurrencyAndAmount
    {
        ...
        /// <summary>
        /// Código moneda ISO 4217.
        /// </summary>
        [XmlAttribute()]
        public string Ccy { get; set; }

        /// <summary>
        /// Importe del valor monetario.
        /// </summary>
        [XmlText()]
